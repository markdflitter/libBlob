...
TEST (test_5_0_blob_is_in_same_square_t, different_squares)
{
...
TEST (test_5_0_blob_is_in_same_square_t, identical_position)
{
	Blob b1 = CreateBlob ().position (make_pt (10.0, 20.0));
...
TEST (test_5_0_blob_is_in_same_square_t, different_position_in_square)
{
...
TEST (test_5_0_blob_is_in_same_square_t, minus_different_position_in_square)
{
	Blob b1 = CreateBlob ().position (make_pt (-10.1, -20.1));
	Blob b2 = CreateBlob ().position (make_pt (-10.9, -20.9));
...
TEST (test_5_0_blob_is_in_same_square_t, different_squares_but_still_in_range)
{
