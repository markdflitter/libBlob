...
TEST (test_11_04_blob_chooseNextAction_t, fight)
{
...
TEST (test_11_04_blob_chooseNextAction_t, hunt)
{
...
TEST (test_11_04_blob_chooseNextAction_t, flee_same_square)
{
	std::vector <Blob> b {weaker, stronger.position (make_pt (5.5, 5.5))};
...
TEST (test_11_04_blob_chooseNextAction_t, flee_in_range)
{
	std::vector <Blob> b {weaker, stronger};
	auto action = b[0].chooseNextAction (b);
	ASSERT_TRUE (std::dynamic_pointer_cast <Movement> (action));
...
TEST (test_11_04_blob_chooseNextAction_t, wander)
{
...
TEST (test_11_04_blob_chooseNextAction_t, dead_blobs_do_nothing)
{
...
TEST (test_11_04_blob_chooseNextAction_t, dead_blobs_do_not_age)
{
