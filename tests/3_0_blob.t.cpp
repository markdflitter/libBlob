...
TEST (test_3_0_blob_t, create_default_blob)
{
	Blob b = CreateBlob ();
}

TEST (test_3_0_blob_t, name)
{
	Blob mark = CreateBlob ().name("mark");
	EXPECT_EQ (mark.name (), "mark");
}

TEST (test_3_0_blob_t, position)
{
