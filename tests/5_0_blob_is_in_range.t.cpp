...
TEST (test_5_0_blob_is_in_range_t, out_of_range_x)
{
...
TEST (test_5_0_blob_is_in_range_t, in_range_x)
{
	Blob b1 = CreateBlob ().position (make_pt (0.0, 0.0));
	Blob b2 = CreateBlob ().position (make_pt (10.0, 0.0));
...
TEST (test_5_0_blob_is_in_range_t, out_of_range_y)
{
	Blob b1 = CreateBlob ().position (make_pt (0.0, 0.0));
...
TEST (test_5_0_blob_is_in_range_t, in_range_y)
{
	Blob b1 = CreateBlob ().position (make_pt (0.0, 0.0));
...
TEST (test_5_0_blob_is_in_range_t, out_of_range_xy)
{
...
TEST (test_5_0_blob_is_in_range_t, in_range_xy)
{
	Blob b1 = CreateBlob ().position (make_pt (3.0, 4.0));
	Blob b2 = CreateBlob ().position (make_pt (6.0, 8.0));
