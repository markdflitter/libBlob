...
TEST (test_7_1_blob_move_t, do_not_move)
{
	Blob b1 = CreateBlob ();
	b1.move (0.0, 0.0, "");
...
TEST (test_7_1_blob_move_t, move_north)
{
...
TEST (test_7_1_blob_move_t, move_south)
{
...
TEST (test_7_1_blob_move_t, move_minus_south)
{
	Blob b1 = CreateBlob ().position (make_pt (10.1, 20.2));
	b1.move (5.0, -M_PI, "move south");
...
TEST (test_7_1_blob_move_t, move_east)
{
	Blob b1 = CreateBlob ().position (make_pt (10.1, 20.2));
...
TEST (test_7_1_blob_move_t, move_west)
{
	Blob b1 = CreateBlob ().position (make_pt (10.1, 20.2));
...
TEST (test_7_1_blob_move_t, move_minus_west)
{
	Blob b1 = CreateBlob ().position (make_pt (10.1, 20.2));
...
TEST (test_7_1_blob_move_t, move_north_east)
{
	Blob b1 = CreateBlob ().position (make_pt (10.1, 20.2));
...
TEST (test_7_1_blob_move_t, move_north_west)
{
	Blob b1 = CreateBlob ().position (make_pt (10.1, 20.2));
...
TEST (test_7_1_blob_move_t, move_south_east)
{
	Blob b1 = CreateBlob ().position (make_pt (10.1, 20.2));
...
TEST (test_7_1_blob_move_t, move_south_west)
{
	Blob b1 = CreateBlob ().position (make_pt (10.1, 20.2));
...
TEST (test_7_1_blob_move_t, move_minus_south_west)
{
	Blob b1 = CreateBlob ().position (make_pt (10.1, 20.2));
...
TEST (test_7_1_blob_move_t, move_negative_x)
{
	Blob b1 = CreateBlob ().position (make_pt (10.1, 20.2));
...
TEST (test_7_1_blob_move_t, move_negative_y)
{
	Blob b1 = CreateBlob ().position (make_pt (10.1, 20.2));
	b1.move (30.0, M_PI, "-y");
...
TEST (test_7_1_blob_move_t, move_fast)
{
	Blob b1 = CreateBlob ().position (make_pt (10.1, 20.2));
...
TEST (test_7_1_blob_move_t, move_limit_minx)
{
	Blob b1 = CreateBlob ();
...
TEST (test_7_1_blob_move_t, move_limit_maxx)
{
	Blob b1 = CreateBlob ();
...
TEST (test_7_1_blob_move_t, move_limit_miny)
{
	Blob b1 = CreateBlob ();
	b1.move (1200.0, M_PI, "");
...
TEST (test_7_1_blob_move_t, move_limit_maxy)
{
	Blob b1 = CreateBlob ();
	b1.move (1200.0, 0.0, "");
...
TEST (test_7_1_blob_move_t, move_hitPoints_recover)
{
