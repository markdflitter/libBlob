...
auto weakest = CreateBlob ().HP (25U).position (make_pt (5.0, 5.0)).lifespan (1000U);
auto weaker = CreateBlob ().HP (50U).position (make_pt (5.0, 5.0)).lifespan (1000U);
auto stronger = CreateBlob ().HP (200U).damage (100U).position (make_pt (5.0, 5.0)).lifespan (1000U);
auto strongest = CreateBlob ().HP (200U).damage (200U).position (make_pt (5.0, 5.0)).lifespan (1000U);
